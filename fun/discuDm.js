...
exports.dmDiscu = message => {
   ...
   if(message.content.startsWith(index.p)) return;
    ...
    const answer_Sun = [`Habibati <:Frog_owi:899344705186316288>`, `Shaytan recue !`, `Wsh bien ou quoi oukhty ?`, `Attends je prie la !`, `Ton père arabe a voler toute les étoiles pour les mettre dans tes yeux <:Frog_owi:899344705186316288>`, `Ton père n’est pas un fermier arabe ? Parce que t’es un beau mouton <:Frog_owi:899344705186316288>`, `Ton père arabe a volé Windows de mon ordinateur… Parce que franchement tu m’as fait buguer… <:Frog_owi:899344705186316288>`, `Excuse moi, je suis perdue, tu serais pas un arabe qui pourrait m’indiquer le chemin qui mène à ton coeur…? <:Frog_owi:899344705186316288>`, `Excuse moi, je suis perdue, tu serais pas un arabe qui pourrait m’indiquer le chemin qui mène à ton coeur…? <:Frog_owi:899344705186316288>`,`T'es arabe, t'as volé mon coeur... <:Frog_owi:899344705186316288>`, `T'es comme une tongue lancée par ta mère arabe, tu me rates jamais... <:Frog_owi:899344705186316288>`, `Tu peux quitter mes dm ? Soleil arabe que tu es, tu me fais fondre <:Frog_owi:899344705186316288>`, `T'es comme une oasis dans un désert arabe...unique et merveilleuse <:Frog_owi:899344705186316288>`, `Couscous, merguez, foufounne, toussa toussa`];
    const answer_Raven = [`7ayatiiii ! <:ouioui:868792198492221491>`, `J'ai une blague ! "Qu'est ce qui rends 9 personne sur 10 heureuse ?"\n-un viol collectif`, `Mommy sugar, ca va?`, `Je te donne 10/10 ! <:Kappa:710249724380315649>` ];
    const answer_Keilie= [`Bébou grrrr`, `Je te donne ma langue  <:ouioui:868792198492221491>`, `Tu sais quel est le point en commun entre toi et une frite ? Vous êtes petits <:Frog_owi:899344705186316288>`, `Coucou la maman de mini super-man <:ouioui:868792198492221491>`, `Les mollets d'acier 😳`, `On m'a dit que tu fais de l'escalade, tu voudrais pas escalader ma bi.. allo ?`, `On m'a dit que tu fais de l'escalade, j'aimerai escalader dans ton amour <:Frog_owi:899344705186316288>`, `Tu fais quoi ? Je m'ennuie. Dis, tu ramasses des munitions ?`];
    const value1 = 0;
    const value2 = 1;
    var number = 0;
    var answer = " ";
